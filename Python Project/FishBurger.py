...
# Form implementation generated from reading ui file 'FishBurger.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_FishBurger = QtWidgets.QLabel(Dialog)
        self.lbl_FishBurger.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_FishBurger.setFont(font)
        self.lbl_FishBurger.setObjectName("lbl_FishBurger")
        ...
        self.lbl_FishBurger_de = QtWidgets.QLabel(Dialog)
        self.lbl_FishBurger_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_FishBurger_de.setFont(font)
        self.lbl_FishBurger_de.setObjectName("lbl_FishBurger_de")
        ...
        self.frame.setGeometry(QtCore.QRect(90, 150, 181, 141))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/fishburger.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_FishBurger.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_FishBurger_de.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_FishBurger.setText(_translate("Dialog", "FishBurger"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_FishBurger_de.setText(_translate("Dialog", "FishBurger"))
