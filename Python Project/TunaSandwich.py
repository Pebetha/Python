...
# Form implementation generated from reading ui file 'TunaSandwich.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_TunaSandwich = QtWidgets.QLabel(Dialog)
        self.lbl_TunaSandwich.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_TunaSandwich.setFont(font)
        self.lbl_TunaSandwich.setObjectName("lbl_TunaSandwich")
        ...
        self.frame.setStyleSheet("border-image: url(:/newPrefix/tunasandwich.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.lbl_TunaSandwich_de = QtWidgets.QLabel(Dialog)
        self.lbl_TunaSandwich_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_TunaSandwich_de.setFont(font)
        self.lbl_TunaSandwich_de.setObjectName("lbl_TunaSandwich_de")
        ...
        self.frame_2.raise_()
        self.lbl_TunaSandwich.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.frame.raise_()
        self.lbl_TunaSandwich_de.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_TunaSandwich.setText(_translate("Dialog", "TunaSandwich"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_TunaSandwich_de.setText(_translate("Dialog", "TunaSandwich"))
