...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_Frenchfrise = QtWidgets.QLabel(Dialog)
        self.lbl_Frenchfrise.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_Frenchfrise.setFont(font)
        self.lbl_Frenchfrise.setObjectName("lbl_Frenchfrise")
        ...
        self.lbl_Frenchfrise_de = QtWidgets.QLabel(Dialog)
        self.lbl_Frenchfrise_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_Frenchfrise_de.setFont(font)
        self.lbl_Frenchfrise_de.setObjectName("lbl_Frenchfrise_de")
        ...
        self.frame.setGeometry(QtCore.QRect(90, 160, 181, 151))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/frenchfries.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_Frenchfrise.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_Frenchfrise_de.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_Frenchfrise.setText(_translate("Dialog", "Frenchfries"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_Frenchfrise_de.setText(_translate("Dialog", "Frenchfries"))
