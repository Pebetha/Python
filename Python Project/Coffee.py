...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_Coffee = QtWidgets.QLabel(Dialog)
        self.lbl_Coffee.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_Coffee.setFont(font)
        self.lbl_Coffee.setObjectName("lbl_Coffee")
        ...
        self.lbl_Coffee_de = QtWidgets.QLabel(Dialog)
        self.lbl_Coffee_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_Coffee_de.setFont(font)
        self.lbl_Coffee_de.setObjectName("lbl_Coffee_de")
        ...
        self.frame.setGeometry(QtCore.QRect(70, 160, 201, 121))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/coffee.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_Coffee.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_Coffee_de.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_Coffee.setText(_translate("Dialog", "Coffee"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_Coffee_de.setText(_translate("Dialog", "Coffee"))
        self.lbl_Price.setText(_translate("Dialog", "Price : 25 Bath"))
import Picture
