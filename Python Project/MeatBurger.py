...
# Form implementation generated from reading ui file 'MeatBurger.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_MeatBurger = QtWidgets.QLabel(Dialog)
        self.lbl_MeatBurger.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_MeatBurger.setFont(font)
        self.lbl_MeatBurger.setObjectName("lbl_MeatBurger")
        ...
        self.frame.setGeometry(QtCore.QRect(10, 80, 201, 121))
        self.frame.setStyleSheet("image: url(:/newPrefix/download.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.lbl_MeatBurger_2 = QtWidgets.QLabel(Dialog)
        self.lbl_MeatBurger_2.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_MeatBurger_2.setFont(font)
        self.lbl_MeatBurger_2.setObjectName("lbl_MeatBurger_2")
        ...
        self.frame_2.raise_()
        self.lbl_MeatBurger.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.frame.raise_()
        self.lbl_MeatBurger_2.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_MeatBurger.setText(_translate("Dialog", "MeatBurger"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_MeatBurger_2.setText(_translate("Dialog", "MeatBurger"))
