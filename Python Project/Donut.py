...
# Form implementation generated from reading ui file 'Donut.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_Donut = QtWidgets.QLabel(Dialog)
        self.lbl_Donut.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_Donut.setFont(font)
        self.lbl_Donut.setObjectName("lbl_Donut")
        ...
        self.lbl_Donut_de = QtWidgets.QLabel(Dialog)
        self.lbl_Donut_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_Donut_de.setFont(font)
        self.lbl_Donut_de.setObjectName("lbl_Donut_de")
        ...
        self.frame.setGeometry(QtCore.QRect(80, 150, 201, 151))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/donut.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_Donut.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_Donut_de.raise_()
