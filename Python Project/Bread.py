...
# Form implementation generated from reading ui file 'Bread.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_Bread = QtWidgets.QLabel(Dialog)
        self.lbl_Bread.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_Bread.setFont(font)
        self.lbl_Bread.setObjectName("lbl_Bread")
        ...
        self.lbl_Bread_de = QtWidgets.QLabel(Dialog)
        self.lbl_Bread_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_Bread_de.setFont(font)
        self.lbl_Bread_de.setObjectName("lbl_Bread_de")
        ...
        self.frame.setGeometry(QtCore.QRect(70, 150, 201, 151))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/bread.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_Bread.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_Bread_de.raise_()
