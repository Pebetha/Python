...
# Form implementation generated from reading ui file 'PorkBurger.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_PorkBurger = QtWidgets.QLabel(Dialog)
        self.lbl_PorkBurger.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.lbl_PorkBurger.setFont(font)
        self.lbl_PorkBurger.setObjectName("lbl_PorkBurger")
        ...
        self.lbl_PorkBurger_de = QtWidgets.QLabel(Dialog)
        self.lbl_PorkBurger_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_PorkBurger_de.setFont(font)
        self.lbl_PorkBurger_de.setObjectName("lbl_PorkBurger_de")
        ...
        self.frame.setGeometry(QtCore.QRect(80, 150, 181, 141))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/porkburger.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_PorkBurger.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_PorkBurger_de.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_PorkBurger.setText(_translate("Dialog", "PorkBurger"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_PorkBurger_de.setText(_translate("Dialog", "PorkBurger"))
        self.lbl_Price.setText(_translate("Dialog", "Price : 40 Bath"))
import Picture
