...
# Form implementation generated from reading ui file 'Water.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbl_Water = QtWidgets.QLabel(Dialog)
        self.lbl_Water.setGeometry(QtCore.QRect(150, 10, 181, 31))
        font = QtGui.QFont()
        ...
        self.lbl_Water_de = QtWidgets.QLabel(Dialog)
        self.lbl_Water_de.setGeometry(QtCore.QRect(260, 70, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lbl_Water_de.setFont(font)
        self.lbl_Water_de.setObjectName("lbl_Water_de")
        ...
        self.frame.setGeometry(QtCore.QRect(60, 150, 201, 151))
        self.frame.setStyleSheet("border-image: url(:/newPrefix/water.jpg);")
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.frame_2.raise_()
        self.lbl_Water.raise_()
        self.but_AddtoCart.raise_()
        self.but_Back.raise_()
        self.lbl_Water_de.raise_()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.lbl_Water.setText(_translate("Dialog", "Water"))
        self.but_AddtoCart.setText(_translate("Dialog", "Add to Cart"))
        self.but_Back.setText(_translate("Dialog", "Back"))
        self.lbl_Water_de.setText(_translate("Dialog", "Water"))
        self.lbl_Price.setText(_translate("Dialog", "Price : 10 Bath"))
import Picture
